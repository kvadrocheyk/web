...
<div class="content">
	<?php
	$on_page=8;
	$num_pages=ceil((mysql_num_rows(mysql_query("SELECT id FROM articles WHERE type=2")))/$on_page);
	...
	$query=mysql_query("SELECT * FROM articles WHERE type=2 ORDER BY DATE DESC LIMIT $start_from, $on_page",$db);
